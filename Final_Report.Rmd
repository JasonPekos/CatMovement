...
```{r Plot_2, echo=FALSE,message=FALSE, fig.height=4,fig.align = 'center'}
...
```{r Plot_3, echo=FALSE,message=FALSE,fig.align = 'center'}
#Track of female cat
n1<-(ggmap(map_one)
...
The time tracking plot was ordered by country and date the GPS device was deployed on the cat. When there was no deployed starting date, the first recorded time stamp for the cat was used. This ordering is visually pleasing, and easily allows the user to assess when cats were tracked for different countries.
