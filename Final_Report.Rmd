...
Drawing straight lines between successive GPS locations can be useful, but it fails to capture the underlying uncertainty in animal tracking data. To deal with this, we utilize Dynamic Brownian Bridge Models (dBMM) to recover Utilization Distributions (UD), which can more accurately capture the most likely home range of different cats. Along with more accurately answering questions around potential home area, Dynamic Brownian Bridge Models provide an interesting qualitative method for forming hypothesis around animal interaction and predation; although cats do tend to stick within 100m of their homes, there is plenty of overlapping home range, especially in the southwest of Adelaide. Asking questions about predation in these areas of high overlap could be interesting. 
