...
DensityPlot = ggplot() +
  geom_density(data = cats, aes(x = timestamp, y = after_stat(count), color = Country, fill = Country), inherit.aes = FALSE)  + theme_tufte() +
  theme(axis.ticks.y = element_blank(), 
        axis.text.y  = element_blank(),
        legend.title = element_blank(),
        legend.position = "none") 

plot_grid(FullPlot, DensityPlot, rel_heights = c(2, 0.7), ncol = 1 ,nrow = 2, align = "v")
...
DensityPlot = ggplot() +
  geom_density(data = CatDFUS, aes(x = timestamp, y = after_stat(count)), inherit.aes = FALSE)  + theme_tufte() +
  theme(axis.ticks.y = element_blank(), 
        axis.text.y  = element_blank(),
        legend.title = element_blank(),
        legend.position = "none") 

plot_grid(USPLOT, DensityPlot, rel_heights = c(2, 0.7), ncol = 1 ,nrow = 2, align = "v")
